...
export const RELIQUES: Relique[] = [
  ...
  // ——— Jeux ———
  {
    ...
    embleme: "♻️",
    categorie: "Jeux",
    description: "Ta première ligne compostée au Tetris. Deux kilos de matière organique sacrée.",
  ...
  },
  {
    ...
    embleme: "🧱",
    categorie: "Jeux",
    description: "Un score de 600 au Tetris du Compost. Sœur Compost note la performance, sobrement.",
    condition: "Atteindre 600 points au Tetris",
